import{L as Nn,q as Lt,t as On,u as An,v as p,_ as je,x as K,y as w,z as ut,C as dt,A as ht,B as Ut,D as bn,E as Ln,F as Un,G as qe,S as se,H as $e,I as Dn,J as Mn,M as Y,N as X,O as Dt,P as Vn,Q as R,R as Fn,T as Wn,W as xn,U as G,V as he}from"./index-BK_SWt9q.js";function Mt(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Hn=Mt,Vt=new $e("auth","Firebase",Mt());/**
 * @license
